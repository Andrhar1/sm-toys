...
if(isset($_GET['data'])){
	...
	$sql_d = "select `kategori_produk` from `kategori_produk` where `id_kategori_produk` = '$id_kategori_produk'";
...
?>
    ...
    <div class="card card-info">
      ...
      <?php if($_GET['notif']=="editkosong"){?>
          ...
          Maaf data kategori produk wajib di isi</div>
      <?php }?>
      <?php }?>
      </div>
      <form class="form-horizontal" action = "index.php?include=konfirmasi-edit-kategori-produk" method="post">
        <div class="card-body">
