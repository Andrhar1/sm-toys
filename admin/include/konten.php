    ...
    <section class="content">
            <div class="card">
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    if(isset($kata_kunci) && !empty($kata_kunci)){
                      $sql_k .= "WHERE `judul` LIKE '%$kata_kunci%' ";
                    }
              ...
              <div class="card-footer clearfix">
                  ...
                  $sql_jum = "select `id_konten`, `judul` from    
                          `konten`"; 
                  if(isset($kata_kunci) && !empty($kata_kunci)){
                    $sql_k .= "WHERE `judul` LIKE '%$kata_kunci%' ";
                  }
                  ...
                  if($halaman!=1){
                    ...
                    <a class='page-link' href='index.php?include=konten&halaman=1'>
                    First</a></li>";
                    echo "<li class='page-item'>
                    <a class='page-link' href='index.php?include=konten&halaman=$sebelum'>
                    «</a></li>";
                  }
